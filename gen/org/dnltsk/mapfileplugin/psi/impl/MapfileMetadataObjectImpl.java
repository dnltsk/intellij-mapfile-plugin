...
import org.dnltsk.mapfileplugin.psi.MapfileMetadataObjectChildren;
...
public class MapfileMetadataObjectImpl extends ASTWrapperPsiElement implements MapfileMetadataObject {
  ...
  @Override
  @NotNull
  public List<MapfileMetadataObjectChildren> getMetadataObjectChildrenList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MapfileMetadataObjectChildren.class);
  }
