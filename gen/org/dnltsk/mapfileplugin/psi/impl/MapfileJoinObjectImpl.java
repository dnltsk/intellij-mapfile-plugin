...
import org.dnltsk.mapfileplugin.psi.MapfileJoinObjectChildren;
...
public class MapfileJoinObjectImpl extends ASTWrapperPsiElement implements MapfileJoinObject {
  ...
  @Override
  @NotNull
  public List<MapfileJoinObjectChildren> getJoinObjectChildrenList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MapfileJoinObjectChildren.class);
  }
