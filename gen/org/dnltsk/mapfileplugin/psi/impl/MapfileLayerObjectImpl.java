...
import org.dnltsk.mapfileplugin.psi.MapfileLayerObjectChildren;
...
public class MapfileLayerObjectImpl extends ASTWrapperPsiElement implements MapfileLayerObject {
  ...
  @Override
  @NotNull
  public List<MapfileLayerObjectChildren> getLayerObjectChildrenList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MapfileLayerObjectChildren.class);
  }
